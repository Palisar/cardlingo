        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DeckId = table.Column<int>(type: "int", nullable: false),
                    PileId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReviewHistories_Cards_CardId",
                        column: x => x.CardId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Piles_DeckId",
                table: "Piles",
                column: "DeckId");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewHistories_CardId",
